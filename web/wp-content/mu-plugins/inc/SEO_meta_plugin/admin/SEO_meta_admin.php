 ...
 * meta description = get_post_meta( get_the_ID(), 'seo_meta_meta-description', true )
 * Facebook title = get_post_meta( get_the_ID(), 'seo_meta_facebook-title', true )
 * Facebook description = get_post_meta( get_the_ID(), 'seo_meta_facebook-description', true )
 * Facebook image = get_post_meta( get_the_ID(), 'seo_meta_facebook-image', true )
 */
class Template_Theme_SEO_Meta_Plugin
{
    ...
    public function admin_head()
    {
        ...
        <table class="form-table" role="presentation">
            <tbody>
                ...
                private function media_button($field)
                {
                    printf(
                        ...
                        isset($field['modal-button']) ? $field['modal-button'] : __('Select this file', 'template-theme-MU-plugin'),
                        isset($field['modal-title']) ? $field['modal-title'] : __('Choose a file', 'template-theme-MU-plugin'),
                        $field['return'],
                        $field['id'],
                        $field['id'],
                        isset($field['button-text']) ? $field['button-text'] : __('Upload', 'template-theme-MU-plugin')
                    );
                }
            ...
            new Template_Theme_SEO_Meta_Plugin;
